...
./ms_line -train ../data/dblp.authors.net.shuf.train -output vec_2nd_wo_norm.txt -binary 0 -size 50 -order 2 -negative 5 -samples 500 -threads 5 -sense -1 -gap -0.95

./predict ../data/node.lis vec_2nd_wo_norm.txt.all.emb vec_2nd_wo_norm.txt.cemb ../data/dblp.authors.net.shuf.train ../data/dblp.authors.net.shuf.test testSet.predict misSet.predict
